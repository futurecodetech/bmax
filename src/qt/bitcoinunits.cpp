...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("BMAX");
    case mBTC: return QString("mBMAX");
    case uBTC: return QString::fromUtf8("μBMAX");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("BMAXs"));
    case mBTC: return QString(QObject::tr("Milli-BMAXs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-BMAXs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
