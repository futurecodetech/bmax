...
const string strMessageMagic = "BMAXCOIN Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("BMAXCOIN-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in BMAXCOIN
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // BMAXCOIN: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BMAXCOIN", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "The kingslayer is coming BMAX..BOOM ";
        CTransaction txNew;
        txNew.nTime = 1515677950;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1515677950;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 218297 : 200643;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x7e62f3e3b35f28612b15815f573e6a5ea0cd01bc4afe7763ddc5ee92f5863155"));
...
unsigned char pchMessageStart[4] = { 0xa8, 0xf9, 0xea, 0xec };
